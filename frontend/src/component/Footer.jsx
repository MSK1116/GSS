...
const Footer = () => {
  return (
    <>
      <footer className="max-w-screen-2xl container mx-auto md:px-20px  footer fixed bottom-0 footer-center bg-yellow-300 text-white  p-10">
        <aside>
