                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                  ...
                  <div className="mt-10 flex flex-col items-center md:flex-row">
                    ...
                    <a href="/" aria-label="" className="group inline-flex items-center font-semibold text-g1">
                      Know about faculty
                      <svg xmlns="http://www.w3.org/2000/svg" className="ml-4 h-6 w-6 transition-transform group-hover:translate-x-2 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
